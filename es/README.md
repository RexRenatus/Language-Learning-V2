...
> 13,121 vocab words** (~184 MB). It opens with **4 from-zero foundation units** (alphabet & sounds
...
>
> **[⬇ Course-Spanish.apkg](https://storage.googleapis.com/aol-language-decks-v2/v2/course/Course-Spanish.apkg)** (~184 MB) ·
