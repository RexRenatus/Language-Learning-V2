...
>
> The flagship Spanish product is the **Progressive Course**: **79 units, A1→C2, 28,898 cards,
> 13,121 vocab words** (~198 MB). It opens with **4 from-zero foundation units** (alphabet & sounds
...
>
> **[⬇ Course-Spanish.apkg](https://storage.googleapis.com/aol-language-decks-v2/v2/course/Course-Spanish.apkg)** (~198 MB) ·
