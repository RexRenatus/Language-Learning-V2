...
Curated multilingual flashcards for **Spanish, Japanese, Chinese (Mandarin), and Korean**.

**171,857 cards across 37 decks** spanning vocabulary, function words, grammar patterns, sentence mining, conjugation, counters, synonyms, and honorifics. Every cloze-MCQ card has a `— W H Y —` reasoning block on the back generated by Gemini.
...
| Total study items | 40,000 | **171,857** |
