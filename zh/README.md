...
>
> 💡 **New —** vocab cards now carry a **back-only memory-aid mnemonic** that never leaks the answer (~91% of vocab notes — A1–B2 core + full C1/C2 coverage) — browse via the `has::mnemonic` tag. (SPEC-LANG-011, SPEC-LANG-012)
