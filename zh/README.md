...
>
> The flagship Chinese product is the **Progressive Course**: **86 units, A1→C2, 25,599 cards,
> 11,562 vocab words** (~115 MB). It opens with **4 from-zero foundation units** (pinyin + the four
...
>
> **[⬇ Course-Chinese.apkg](https://storage.googleapis.com/aol-language-decks-v2/v2/course/Course-Chinese.apkg)** (~115 MB) ·
