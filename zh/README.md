...
> 11,469 vocab words** (~175 MB). It opens with **4 from-zero foundation units** — the pronunciation
...
>
> **[⬇ Course-Chinese.apkg](https://storage.googleapis.com/aol-language-decks-v2/v2/course/Course-Chinese.apkg)** (~175 MB) ·
