...
>
> The flagship French product is the **Progressive Course**: **81 units, A1→C2, 34,824 cards,
> 16,134 vocab words** (~131 MB). It opens with **4 from-zero foundation units** (alphabet & sounds
...
> standard), and native-speaker audio throughout. Eight card types — incl. B1+ **mediation · composition · reading** and a **gender** drill (type the noun with its article: *la nuit*, *le problème*) — **zero multiple-choice**.
>
> **[⬇ Course-French.apkg](https://storage.googleapis.com/aol-language-decks-v2/v2/course/Course-French.apkg)** (~131 MB) ·
